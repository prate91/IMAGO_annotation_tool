...
# JSON file paths
WORK_PATH = os.path.join(BASE_DIR, 'json/aggiunte_opere_20221117.json') #'json/outputWorksNew.json'
AUTHOR_PATH = os.path.join(BASE_DIR, 'json/aggiunte_autori_20221117.json') #'json/outputAuthorsFinalDate.json'
